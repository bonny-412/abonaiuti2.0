            ...
            $.ajax({
                ...
                success: function(result) {
                    if (result == "success") {
                        ...
                        $(".output_message").text("Messaggio inviato!");
                    } else {
                        $(".contactform").find(".output_message").addClass("error");
                        $(".output_message").text("Errore durante l'invio del messaggio!");
                    }
                }
            });
